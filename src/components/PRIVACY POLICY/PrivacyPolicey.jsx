...
function PrivacyPolicey() {
  useEffect(() => {
    window.scrollTo(0, 0);
  });
  return (
    <div>
      <div className="container-fluid maindivuper">
        <div className="container">
          ...
          <p className="Introdiv">INTRODUCTION</p>
          <div className="IntrodutionText">
            <p>Last Updated November 2021</p>
            <p>
              Crypto Car Club is committed to safeguarding your privacy. Contact
              us at info@cryptocarclub.co if you have any questions or problems
              regarding the use of your Personal Data and we will gladly assist
              you.
            </p>
            <p>
          ...
          <div className="Definitions">
            ...
            <p>
              ...
              identifiable natural person. Processing – any operation or set of
              operations which is performed on Personal Data or on sets of
              Personal Data.
            </p>
            <p>
              Data subject – a natural person whose Personal Data is being
              Processed.
            </p>
            <p>Child – a natural person under 16 years of age.</p>
            <p>We/us (either capitalized or not) – Crypto Car Club</p>
          </div>
          <div className="Definitions">
            ...
            <p>
              ...
              have lawful grounds. We always consider your rights before
              Processing Personal Data. We will provide you information
            ...
            <p>
              We will do our best to ensure the accuracy of data.We will do our
              best to ensure the integrity and confidentiality of data.
            </p>
            <p></p>
          </div>
          <div className="Definitions">
            <h1>DATA SUBJECT’S RIGHTS</h1>
            <p>The Data Subject has the following rights:</p>
            <p>
              Right to information – meaning you have to right to know whether
            ...
            <p>
              ...
              <a
                target="_blank"
                href="https://www.otomotors.io/#gdpr-contact"
                style={{ color: "#ffa05f" }}
              >
                supervisory authority
              </a>
              – meaning you have the right for the help of a supervisory
              authority and the right for other legal remedies such as claiming
              damages.
            </p>
            <p>
              Right to withdraw consent – you have the right withdraw any given
              consent for Processing of your Personal Data.
            </p>
          </div>
          <div className="Definitions">
            <h1>DATA WE GATHER</h1>
            <p>CRYPTO CAR CLUB– Information you have provided us with</p>
            <p>
              This might be your e-mail address, name, billing address, home
              address etc – mainly information that is necessary for delivering
              you a product/service or to enhance your customer experience with
              us. We save the information you provide us with in order for you
              to comment or perform other activities on the website. This
              information includes, for example, your name and e-mail address.
            </p>
            <p>
              CRYPTO CAR CLUB– Information automatically collected about you
            </p>
            <p>
              This includes information that is automatically stored by cookies
              and other session tools. For example, your shopping cart
              information, your IP address, your shopping history (if there is
              any) etc. This information is used to improve your customer
              experience. When you use our services or look at the contents of
              our website, your activities may be logged.
            </p>
            <p>CRYPTO CAR CLUB– Information from our partners</p>
            <p>
              We gather information from our trusted partners with confirmation
              that they have legal grounds to share that information with us.
              This is either information you have provided them directly with or
              that they have gathered about you on other legal grounds. See the
              list of our partners
              <a
                target="_blank"
                href="https://www.otomotors.io/#gdpr-sharing"
                style={{ color: "#ffa05f" }}
              >
                here
              </a>
          ...
          <div className="Definitions">
            ...
            <p>
              provide our service to you. This includes for example registering
              your account; providing you with other products and services that
              you have requested; providing you with promotional items at your
              request and communicating with you in relation to those products
              and services; communicating and interacting with you; and
              notifying you of changes to any services.
            </p>
            <p>enhance your customer experience.</p>
            <p>fulfil an obligation under law or contract.</p>
            <p>
              We use your Personal Data on legitimate grounds and/or with your
              Consent.
            </p>
            <p>
              On the grounds of entering a contract or fulfilling contractual
            ...
            <p>
              to send you newsletters and campaign offers (from us and/or our
              carefully selected partners); for other purposes we have asked
              your consent for.
            </p>
            <p className="mt-3">
              We Process your Personal Data in order to fulfil obligation rising
              from law and/or use your Personal Data for options provided by
              law. We reserve the right to anonymise Personal Data gathered and
              to use any such data. We will use data outside the scope of this
              Policy only when it is anonymized. We save your billing
              information and other information gathered about you for as long
              as needed for accounting purposes or other obligations deriving
              from law, but not longer than CRYPTO CAR CLUB
            </p>
            <p>
            ...
            <p>there would be appropriate safeguard for Processing.</p>
            ...
            <p>
              ...
              adequate level of protection to your Personal Data. We disclose
              your Personal Data to third parties or public officials when we
              are legally obliged to do so. We might disclose your Personal Data
            ...
            <p>
              ...
              We use anonymizing and pseudonymizing where suitable. We monitor
              our systems for possible vulnerabilities and attacks. CRYPTO CAR
              CLUB– describe additional security measures.
            </p>
            <p>
              ...
              data breaches. We will also notify you if there is a threat to
              your rights or interests. We will do everything we reasonably can
              to prevent security breaches and to assist authorities should any
              breaches occur.
            </p>
            <p>
              If you have an account with us, note that you have to keep your
            ...
            <p>
              Cookies and other technologies we use We use cookies and/or
              similar technologies to analyse customer behaviour, administer the
              website, track users’ movements, and to collect information about
              users. This is done in order to personalise and enhance your
              experience with us.
            </p>
            <p>
              ...
              your cookies at the browser level. Choosing to disable cookies may
              hinder your use of certain functions.
            </p>
          </div>
          <div className="Definitions">
            <h1>WE USE COOKIES FOR THE FOLLOWING PURPOSES:</h1>
            <p>
              Necessary cookies – these cookies are required for you to be able
              to use some important features on our website, such as logging in.
            ...
            <p>
              ...
              your name and e-mail in comment forms so you don’t have to
              re-enter this information next time when commenting.
            </p>
            <p>
            ...
            <p>
              ...
              advertisement. They are usually placed to the website by
              advertising networks with the website operator’s permission. These
              cookies remember that you have visited a website and this
              information is shared with other organizations such as
              advertisers. Often targeting or advertising cookies will be linked
            ...
            <p>
              We use Google Analytics to measure traffic on our website. Google
              has their own Privacy Policy which you can review{" "}
              <a
                target="_blank"
              ...
              . If you’d like to opt out of tracking by Google Analytics, visit
              the
              <a
                target="_blank"
          ...
          <div className="Definitions">
            ...
            <p>
              ...
              reason. If we believe that the changes are material, we will also
              let you know through posting about the changes on our Site. The
              date the Privacy Policy was last revised is identified at the
              beginning of this Privacy Policy. It is important that the
              Personal Data we hold about you is accurate and current. You are
              responsible for ensuring we have an up-to-date active and
              deliverable email address for you, and for keeping us informed if
              your Personal Data changes during your relationship with us. We
              also encourage you to periodically visit our Site and this Privacy
